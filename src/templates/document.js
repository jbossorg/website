...
<head>
    ...
    <link rel="stylesheet" href="/website/css/jbossorg.css">
</head>
  ...
  <footer>
    ...
    <div class="redhat-footer">
        ...
        <span class="redhat-logo">
          <a href="https://www.redhat.com/" target="_blank"><img src="/website/img/redhat_reversed.svg"></a>
        </span>
    </div>
  </footer>
  <script type="module" src="/website/js/cpx-search/cpx-query.js"></script>
  <script type="module" src="/website/js/cpx-search/cpx-results.js"></script>
  <script type="module" src="/website/js/pfe-avatar/dist/pfe-avatar.js"></script>
  <script type="module" src="/website/js/pfe-datetime/dist/pfe-datetime.js"></script>
  <script src="/website/js/jbossorg.js"></script>
</body>
</html>
`;
